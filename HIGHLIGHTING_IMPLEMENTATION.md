# Code Awareness Emacs Highlighting Implementation

## Overview

This document describes the highlighting implementation for the Code Awareness Emacs extension, which mirrors the functionality of the VSCode version.
